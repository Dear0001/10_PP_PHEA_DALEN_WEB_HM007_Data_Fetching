...
const HollywoodMovie = async () => {
    const HollywoodMovie = await getAllMoviesByGenre("Hollywood");
    // console.log(HollywoodMovie);
    return (
        <>
            <div className="flex max-w-[1145px] flex-col mx-auto px-5">
                <h1 className="py-5 font-bold text-white"> Hollywood Movie &gt;</h1>
                <div className="flex overflow-x-auto pb-5 hide-scroll-bar">
                    <div className="flex">
                        {HollywoodMovie?.payload?.map((movie) => (
