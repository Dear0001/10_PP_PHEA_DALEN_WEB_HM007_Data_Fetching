...
const AllMovies = async () => {
    ...
    console.log(AllMovies.payload);


    return (
        <>
            <div className="flex max-w-[1145px] flex-col mx-auto px-5">
                <h1 className="py-5 font-bold text-white"> All Movie &gt;</h1>
                        ...
                        {AllMovies?.payload?.map((movie) => (
                            ...
                            <Link href={`/view-movie/${movie.movie_id}`}>
                                ...
                                <div
                                    ...
                                    <div
                                        className="relative mx-4 mt-4 h-35 overflow-hidden rounded-t-xl bg-white bg-clip-border shadow-lg">
                                        <Image
                                            width={500}
                                            height={500}
